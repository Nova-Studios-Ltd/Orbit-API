...
{
    [Route("Message")]
    [Obsolete("Please use /Channel/{channel_uuid}/Messages")]
    [ApiController]
    [TokenAuthorization]
    public class MessageControllerObsolete : ControllerBase
    {
        private readonly NovaChatDatabaseContext Context;
        private readonly EventManager Event;
        public MessageControllerObsolete(NovaChatDatabaseContext context, EventManager em)
        {
            Context = context;
            Event = em;
        }
